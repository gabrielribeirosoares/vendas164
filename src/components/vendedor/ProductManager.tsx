    ...
    <>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3 pt-1">
          {onlyOutOfStock && (
            <div className="flex items-center justify-between rounded-xl border border-amber-500/30 bg-amber-500/10 px-4 py-2 text-xs text-amber-600 dark:text-amber-400">
              <span>Exibindo apenas miniaturas com estoque esgotado.</span>
              {onClearStockFilter && (
                <Button variant="ghost" size="sm" className="h-6 text-xs hover:bg-amber-500/20" onClick={onClearStockFilter}>
                  Limpar filtro
                </Button>
              )}
            </div>
