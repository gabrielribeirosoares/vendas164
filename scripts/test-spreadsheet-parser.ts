...
const csvSemicolon = `Nome;Telefone;Email;Modelo;Marca;Quantidade;Valor Total;Sinal Pago;Status Pagamento;Status Entrega
Carlos Eduardo;(11) 98765-4321;carlos@email.com;Nissan Skyline GT-R R34;Kaido House;1;189,90;50,00;sinal_pago;pendente
Ana Paula;(21) 99887-6655;ana@email.com;Porsche 911 GT3 RS;Mini GT;2;298,00;60,00;quitado;entregue`;
...
assert(parsedA[0]?.quantity === 1, "Caso A (Linha 1): Quantidade 1 lida com sucesso");
...
assert(parsedA[1]?.quantity === 2, "Caso A (Linha 2): Quantidade 2 lida com sucesso");
...
// Caso B: Padrão Vírgula (,) padrão internacional / Google Sheets export com alias Qtd
const csvComma = `Name,WhatsApp,E-mail,Produto,Fabricante,Qtd,Preço,Entrada,Status Pagamento,Status Envio
Roberto Dias,11911112222,roberto@gmail.com,Dodge Viper,Tarmac,3,220.00,0,sem sinal,a caminho`;
...
assert(parsedB[0]?.quantity === 3, "Caso B: Quantidade 3 capturada por alias 'Qtd'");
...
assert(parsedC[0]?.quantity === 1, "Caso C: Quantidade ausente assume padrão 1 (retrocompatibilidade)");
